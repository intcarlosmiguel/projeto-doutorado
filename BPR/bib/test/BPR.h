...
double BPR_single_edge_gradient(double flow, double capacity, double cost_time) {
    double s = pow(flow/capacity, BETA-1);
    if(isnan(s)) {
        printf("Warning: NaN detected in gradient calculation\n");
        return 0.0;
    }
